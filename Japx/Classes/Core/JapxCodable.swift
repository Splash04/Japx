...
public final class JapxEncoder {
    ...
    public func encode<T>(_ value: T, additionalParams: Japx.Parameters? = nil) throws -> Japx.Parameters where T : Encodable {
...
public final class JapxDecoder {
    ...
    public func decode<T>(_ type: T.Type, from json: Japx.Parameters, includeList: String? = nil) throws -> T where T : Decodable {
